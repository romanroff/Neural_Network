...
# alpha = .1                                                                      #
# hidden_size = 4                                                                 # количество узлов в слое
...
#
#
# for iter in range(60):                                                          # 60 эпох обучения
...
#         print(f'Layer{i}: {layer_2[0][0]:.2f}')                                 # вывод результата по входным параметрам
#     print(f"Error: {error_all:.5f}\n")                                          # вывод суммы ошибок
